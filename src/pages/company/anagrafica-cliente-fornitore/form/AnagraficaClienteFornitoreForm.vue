      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-12 col-md-4 form-group" v-if="!invisibleFields['cliente']">
            <input-checkbox
              ...
              label="Cliente"
              :readonlyAttr="readonlyFields['cliente']"
            ></input-checkbox>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-12 col-md-4 form-group" v-if="!invisibleFields['cellulareReferente']">
            <input-text
              v-model="entity['cellulareReferente']"
              label="Cellulare"
  ...
  data() {
    return {
      ...
      propsFields: {
        ...
        ragioneSociale: { bind: 'entitaGiuridica.ragioneSociale' },
        descrAttivita: { bind: 'entitaGiuridica.descrAttivita' },
        codiceFiscale: { bind: 'codiceFiscale' },
        partitaIva: { bind: 'partitaIva' },
        partitaIvaEstera: { bind: 'partitaIvaEstera' },
        telefono: { bind: 'telefono' },
        cellulare: { bind: 'cellulare' },
        naturaGiurica: { bind: 'entitaGiuridica.naturaGiur' },
        cliente: { bind: 'cliente' },
        fornitore: { bind: 'fornitore' },
        statoSedeLegale: { bind: 'entitaGiuridica.indirizzoSedeLegale.stato' },
        provinciaSedeLegale: {
        ...
        viaSedeLegale: { bind: 'entitaGiuridica.indirizzoSedeLegale.via' },
        numeroSedeLegale: {
          bind: 'entitaGiuridica.indirizzoSedeLegale.numero',
        },
        capSedeLegale: { bind: 'entitaGiuridica.indirizzoSedeLegale.cap' },
        statoSedeCostituzione: {
        ...
        dataCostituzione: { bind: 'entitaGiuridica.dataCostituzione' },
        capitaleSociale: { bind: 'entitaGiuridica.capitaleSociale' },
        dataIscrCciaa: { bind: 'entitaGiuridica.dataIscrCciaa' },
        nrIscrCciaa: { bind: 'entitaGiuridica.nrIscrCciaa' },
        provIscrCciaa: { bind: 'entitaGiuridica.provIscrCciaa' },
        aziendaleId: { bind: 'aziendaleId' },
        nomeReferente: { bind: 'contattoReferente.nome' },
        telefonoReferente: { bind: 'contattoReferente.telefono' },
        cellulareReferente: { bind: 'referente.cellulare' },
        emailReferente: { bind: 'contattoReferente.email' },
      },
      modePage: '',
